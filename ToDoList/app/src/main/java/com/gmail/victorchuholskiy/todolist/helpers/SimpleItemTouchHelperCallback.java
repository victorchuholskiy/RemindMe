...
/*  Класс предназначен для RecyclerView. Здесь идет обработка перемещения карточек и удаление свайпом.
    Осуществляется это через обращение к адаптеру и ViewHolder, которые реализуют необходимые интерфейсы.*/
